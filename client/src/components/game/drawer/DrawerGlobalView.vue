...
<template>
  ...
  <div class="fixed inset-0 flex z-40">
    ...
    >
      ...
      <!-- Sidebar Content -->
      <div class="transition-all w-80 duration-700 bg-white flex" v-if="open.value">
        <div class="grid w-80 grid-rows-3 grid-flow-col gap-4">
          ...
          <div class="content-center">
            ...
            <div class="w-full h-full grid grid-rows-4 grid-flow-col gap-2">
              <div class="w-2/5 h-10 m-2">
                <span
                  class="inline-block w-24 bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700"
                  >Gain +3%</span
                >
              </div>
            </div>
