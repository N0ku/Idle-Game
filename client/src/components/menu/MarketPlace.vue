<template>
  <!-- Start block -->
      <div class="mx-auto max-w-screen-xl px-4 lg:px-12 min-h-screen flex justify-center items-center">
          <!-- Start coding here -->
    ...
    return {
      items: [
        // Tous les objets disponibles
        {
          id: 1,
          name: "Item 1",
          image: "../../assets/img/weedcoin.jpeg",
          price: 10,
        },
        {
          id: 2,
      ...
      userItems: [
        // Objets mis en vente par l'utilisateur
        {
          id: 3,
          name: "Item 3",
          image: "../../assets/img/weedcoin.jpeg",
