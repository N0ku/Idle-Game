<template>
  <section class="market-container">
    <!-- Start block -->
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12 min-w-full	">
      <!-- Start coding here -->
      <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
          ...
          <div
            ...
            <button @click="handleAddProductClicked" type="button" id="createProductModalButton"
            ...
            <div class="flex items-center space-x-3 w-full md:w-auto">
              ...
              <div id="filterDropdown" class="z-10 w-56 p-3 bg-white rounded-lg shadow dark:bg-gray-700" v-if="filterDropdown">
                ...
                <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                  <li class="flex items-center"  v-for="(item, index) in ProductsType" v-bind:key="index">
                    ...
                    <label for="apple" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-100">{{ item }}</label>
                  </li>
                </ul>
              </div>
                <button type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" @click="$emit('close-marketplace')">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              <tr class="border-b dark:border-gray-700"  v-for="(item, index) in Sells" v-bind:key="index">
                ...
                <td class="px-4 py-3 flex items-center justify-end">
                  <button id="apple-imac-27-dropdown-button" data-dropdown-toggle="apple-imac-27-dropdown"
                    ...
                    type="button" @click="handleShowDropdown(index)" v-if="showDropdown !== index">
                    ...
                    <ul class="py-1 text-sm" aria-labelledby="item.productName">
                      ...
                      <li>
                        <button type="button" data-modal-target="readProductModal" data-modal-toggle="readProductModal"
                          @click="handleReadProductClicked"
                          class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                          <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20"
                            fill="currentColor" aria-hidden="true">
    ...
    <!-- End block -->
    <!-- Create modal -->
    <div id="createProductModal" tabindex="-1" aria-hidden="true" v-if="createProductModal"
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
          ...
          <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
            ...
            <button type="button"
              ...
              data-modal-target="createProductModal" data-modal-toggle="createProductModal" @click="handleCloseModal">
    ...
    <!-- Update modal -->
    <div id="updateProductModal" tabindex="-1" aria-hidden="true" v-if="updateProductModal"
      class=" overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <div class="relative p-4 w-full max-w-2xl max-h-full">
        <!-- Modal content -->
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
    ...
    <!-- Read modal -->
    <div id="readProductModal" tabindex="-1" aria-hidden="true" v-if="readProductModal"
      class=" overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    ...
    <!-- Delete modal -->
    <div id="deleteModal" tabindex="-1" aria-hidden="true" v-if="deleteModal"
      class=" overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
...
export default {
  setup() {
    ...
    const handleReadProductClicked = (): void => {
      readProductModal.value = true;
    };

    const handleDeleteProductClicked = (): void => {
      deleteModal.value = true;
    };

    const handleAddProductClicked = (): void => {
      createProductModal.value = true;
    };

    const handleShowDropdown = (index: number): void => {
